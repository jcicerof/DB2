...
trace off                                                               00050100
parse arg .                                                             00050200
file.output = 'DB2P.ISERIES.JCL(JCLSUBCK)'                              00053001
                                                                        00054000
...
do until i > maxrec;                                                    00090000
   j = j + 1                                                            00090200
   jobname = 'SDBCHK'                                                   00090301
   output.j = '//SDBCHK19 JOB ,'CICERO',CLASS=S,MSGCLASS=X,'||,         00090401
              'NOTIFY=&SYSUID,REGION=0M'                                00090500
   j = j + 1                                                            00090600
