...
trace off                                                               00050100
parse arg .                                                             00050200
file.output = 'DB2P.ISERIES.JCL(JCLSUBLO)'                              00053001
                                                                        00054000
...
do until i > maxrec;                                                    00090000
   j = j + 1                                                            00090200
   jobname = 'SDBLOA'                                                   00090302
   output.j = '//SDBLOA19 JOB ,'CICERO',CLASS=S,MSGCLASS=X,'||,         00090402
              'NOTIFY=&SYSUID,REGION=0M'                                00090503
   j = j + 1                                                            00090600
