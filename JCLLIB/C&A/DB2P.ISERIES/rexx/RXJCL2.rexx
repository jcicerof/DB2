...
trace off                                                               00050100
parse arg .                                                             00050200
file.output = 'DB2P.ISERIES.JCL(JCLDSN1C)'                              00053000
                                                                        00054000
...
do until i > maxrec;                                                    00090000
   j = j + 1                                                            00090200
   jobname = 'SDBN1C'                                                   00090301
   output.j = '//SDBN1CXX JOB ,'CICERO',CLASS=S,MSGCLASS=X,'||,         00090400
              'NOTIFY=&SYSUID,TYPRUN=HOLD'                              00090500
   j = j + 1                                                            00090600
   output.j = '//         JCLLIB ORDER=(DB2P.ISERIES.PROCLIB)'          00090700
   j = j + 1                                                            00090800
   output.j = '//         SET DT=YYMMDD'                                00090901
   j = j + 1                                                            00091000
   output.j = '//*'                                                     00091100
                                                                        00091200
   do k = 1 to 100                                                      00091300
       line.JCL    = strip(substr(record.i, 1, 80))                     00092000
       j = j + 1                                                        00101000
       say 'Processando ' i                                             00101100
       i = i + 1                                                        00101200
