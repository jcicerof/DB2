...
//SYSIN    DD *                                                         00280000
SELECT CHAR('//'||CHAR(STRIP(NAME), 9)||'EXEC PROC=UNLOADI5,TS='||      00290001
       STRIP(NAME)||',OWNER=PROD', 80)                                  00300001
  FROM SYSIBM.SYSTABLESPACE                                             00310001
 WHERE DBNAME = 'AISERIES'                                              00320001
;                                                                       00330001
//*-------------------------------------------------------------------  00340000
//*                                                                     00350000
//*-------------------------------------------------------------------  00360000
//GENJCL   EXEC PGM=IKJEFT1A,DYNAMNBR=200,PARM='RXCMDLO'                00370001
//SYSEXEC  DD   DSN=&REXXLIB,DISP=SHR                                   00380000
//SYSPRINT DD   SYSOUT=*                                                00390000
//SYSTSPRT DD   SYSOUT=*                                                00400000
//SYSTSIN  DD   DUMMY                                                   00410001
