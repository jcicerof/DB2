...
//*-------------------------------------------------------------------  00020000
//* CRIA MEMBROS CONTENDO O LOAD DE TABLESPACES                         00030002
...
//SYSIN    DD *                                                         00280000
SELECT CHAR('//'||CHAR(STRIP(NAME), 9)||'EXEC PROC=LOAD,TS='||          00290001
       STRIP(NAME)||',DSN=DB2X', 80)                                    00300001
...
//*                                                                     00350000
//*-------------------------------------------------------------------  00360000
//GENJCL   EXEC PGM=IKJEFT1A,DYNAMNBR=200,PARM='RXSUBLO'                00370001
