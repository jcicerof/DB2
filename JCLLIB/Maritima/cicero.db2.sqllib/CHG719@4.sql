CREATE TABLE MARITIMA.HSTAURSM                                                  
    ...
    CCSID EBCDIC                                                                
  AUDIT NONE;                                                                   
-- ***** CARD= 488670 NPAGES= 18160                                             
-- **************************                                                   
-- ***** CREATE INDEXES *****                                                   
-- **************************                                                   
CREATE TYPE 2 UNIQUE INDEX MARITIMA.HSTAURSM_IX1 ON MARITIMA.HSTAURSM           
      ( CDSUCUR ASC ,                                                           
        CDRMBAS ASC ,                                                           
        NRAPOLI ASC ,                                                           
        NRITEM ASC ,                                                            
        NRENDOS ASC  )                                                          
     CLUSTER                                                                    
    USING STOGROUP STGPAEI PRIQTY 18000 SECQTY 1824 ERASE NO                    
    FREEPAGE 0 PCTFREE 0                                                        
    BUFFERPOOL BP2                                                              
    CLOSE YES ;                                                                 
-- ***** NLEAF= 2546 NLEVELS= 3                                                 
-- ***** FIRSTKEYCARD= 10 FULLKEYCARD= 488670                                   
-- **************************                                                   
