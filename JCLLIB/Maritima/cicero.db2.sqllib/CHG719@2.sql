CREATE TABLE ANO2000.MOVAURSM                                                   
    ...
    CCSID EBCDIC                                                                
  AUDIT NONE;                                                                   
-- ***** CARD= 6786 NPAGES= 679                                                 
-- **************************                                                   
-- ***** CREATE INDEXES *****                                                   
-- **************************                                                   
CREATE TYPE 2 UNIQUE INDEX ANO2000.MOVAURSM_IX1 ON ANO2000.MOVAURSM             
      ( CDSUCUR ASC ,                                                           
        CDRMBAS ASC ,                                                           
        NRAPOLI ASC ,                                                           
        NRITEM ASC ,                                                            
        NRENDOS ASC  )                                                          
     CLUSTER                                                                    
    USING STOGROUP STGP13I  PRIQTY 768 SECQTY 96 ERASE NO                       
    FREEPAGE 0 PCTFREE 0                                                        
    BUFFERPOOL BP4                                                              
    CLOSE YES ;                                                                 
-- ***** NLEAF= 36 NLEVELS= 2                                                   
-- ***** FIRSTKEYCARD= 10 FULLKEYCARD= 6786                                     
CREATE TYPE 2  INDEX ANO2000.MOVAURSM_IX2 ON ANO2000.MOVAURSM                   
      ( CHASSAUT ASC  )                                                         
    USING STOGROUP STGP13I  PRIQTY 528 SECQTY 48 ERASE NO                       
    FREEPAGE 0 PCTFREE 0                                                        
    BUFFERPOOL BP4                                                              
    CLOSE YES ;                                                                 
-- ***** NLEAF= 45 NLEVELS= 2                                                   
-- ***** FIRSTKEYCARD= 6629 FULLKEYCARD= 6629                                   
CREATE TYPE 2  INDEX ANO2000.MOVAURSM_IX3 ON ANO2000.MOVAURSM                   
      ( PLACAALF ASC ,                                                          
        PLACANUM ASC  )                                                         
    USING STOGROUP STGP13I  PRIQTY 288 SECQTY 48 ERASE NO                       
    FREEPAGE 0 PCTFREE 0                                                        
    BUFFERPOOL BP4                                                              
    CLOSE YES ;                                                                 
-- ***** NLEAF= 22 NLEVELS= 2                                                   
-- ***** FIRSTKEYCARD= 2348 FULLKEYCARD= 5739                                   
-- **************************                                                   
