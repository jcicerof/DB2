   ...
   if strip(substr(record.i, 2, 4)) = 'DATA' then do                    00260004
      ...
      if j > 0 then do                                                  00261111
         output.j = substr(dataset,1,44,' ')' 'hi_a_rba' 'hi_u_rba||,   00261325
              ...
              ' 'word(translate(dataset,' ','.'), 4)                    00261526
      end                                                               00261722
      ...
      j = j + 1                                                         00271011
           ...
           hi_a_rba = translate(hi_a_rba,'0','-')                       00282321
             ...
             hi_u_rba = strip(substr(record.i, 46, 16))                 00285006
           /* limpar os hifens */                                       00286021
             hi_u_rba = translate(hi_u_rba,'0','-')                     00288021
             end                                                        00290001
   "EXECIO * DISKR infile (stem record."                                00300001
end                                                                     00320001
                                                                        00321003
/* ultimo registro processado */                                        00321113
output.j = substr(dataset,1,44,' ')' 'hi_a_rba' 'hi_u_rba||,            00321226
     ' 'substr(word(translate(dataset,' ','.'), 3), 1, 8)||,            00321326
     ' 'word(translate(dataset,' ','.'), 4)                             00321426
