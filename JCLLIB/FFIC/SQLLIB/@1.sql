@@ERRO - PARA EXECUTAR RETIRAR ESTA LINHA;                              00010000
                                                                        00020000
SET CURRENT SQLID='DBA1ADM';                                            00021000
                                                                        00022000
-- -DROP TABLESPACE DDBA0T00.HSTVSAM;                                   00023000
COMMIT;                                                                 00024000
CREATE TABLESPACE HSTVSAM                                               00030000
    IN DDBA0T00                                                         00040000
    USING STOGROUP GDAP0T00                                             00050000
...
COMMIT;                                                                 00430000
                                                                        00440000
CREATE INDEX DBA1ADM.HSTVSAM_I1                                         00450000
    ON DBA1ADM.HSTVSAM(DATA,DSNAME)                                     00460000
    USING STOGROUP GDAP0T00                                             00470000
