//IBM1JCFA JOB (T00101,520,AU88100,658,000,581),'DB2 DBA TOOL',         JOB03421
...
-- BINDS INICIAIS
--
--GRANT BINDADD, BINDAGENT TO DB2ACPT;
--GRANT BIND    ON PLAN SRS7BDEL TO PUBLIC;
--GRANT EXECUTE ON PLAN SRS7BDEL TO PUBLIC;   -- EXECUTE
-- BIND, COPY E EXECUTE NA COLLECTION DO PACKAGE
--GRANT ALL ON PACKAGE PERT_HOME.* TO PUBLIC;
