...
LISTDEF LISTDBA INCLUDE TABLESPACE DSNDB06.SYSTSTAB                     00210002

TEMPLATE DDREC DSN('DBA5.DB2.UNL.MIGV11.DATA')                          00240002
   DISP(NEW,CATLG,DELETE)                                               00250000
   UNIT SYSDA                                                           00260001

TEMPLATE DDPUN DSN('DBA5.DB2.PUN.MIGV11.DATA')                          00240002
   DISP(NEW,CATLG,DELETE)                                               00250000
   UNIT SYSDA                                                           00260001

UNLOAD LIST LISTDBA                                                     00270000
       UNLDDN DDREC PUNCHDDN DDPUN                                      00280000
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
//SYSUT1   DD DSN=DBA5.DB2.PUN.MIGV11.DATA,DISP=(OLD,DELETE,DELETE)
//SYSUT2   DD SYSOUT=*
//*--------------------------------------------------------------------
//*
//*--------------------------------------------------------------------
