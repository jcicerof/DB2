//DAACUDT1 JOB (S1I201,110),USER=DB2ACPT
/*JOBPARM Z=6,S=ESYS
//****************************************************************  **
//****                                                              **
//**** THIS JOB IMAGE COPIES DATABASE DUDT1A00 IN DB2D              **
//****                                                              **
...
//SYSIN    DD  *
  LISTDEF DUDT1AD
     INCLUDE TABLESPACES DATABASE DUDT1A00 PARTLEVEL
  TEMPLATE LCL1
     ...
     GDGLIMIT(5)
  COPY LIST DUDT1AD COPYDDN (LCL1) SHRLEVEL CHANGE
//*********************************************************************
...
//SYSIN    DD  *
  LISTDEF MODLIST
          INCLUDE TABLESPACE DUDT1A00.*
  MODIFY RECOVERY LIST MODLIST  DELETE AGE(32)
//*
//* LAST UPDATE 05/22/07  REF
